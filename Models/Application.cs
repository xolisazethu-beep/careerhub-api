...
//
// The valid forward transitions between these states are NOT encoded here —
// they live in exactly one place: ApplicationStatusPolicy (see Domain/).
// This enum only names the states; the policy owns the edges between them.
