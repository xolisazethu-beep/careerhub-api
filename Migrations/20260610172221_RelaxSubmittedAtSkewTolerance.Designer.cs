...
namespace CareerHub.Api.Migrations
{
    ...
    [Migration("20260610172221_RelaxSubmittedAtSkewTolerance")]
    partial class RelaxSubmittedAtSkewTolerance
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CareerHub.Api.Models.Application", b =>
                {
                    ...
                    b.ToTable("applications", null, t =>
                        {
                            t.HasCheckConstraint("ck_applications_submitted_not_future", "\"SubmittedAt\" <= now() + interval '5 seconds'");
                        });
                });
